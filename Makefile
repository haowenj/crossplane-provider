...
xpkg.build.provider-ucan: do.build.images
...
dev: $(KIND) $(KUBECTL)
	...
	@$(INFO) Installing Provider Ucan CRDs
	@$(KUBECTL) apply -R -f package/crds
	@$(INFO) Starting Provider Ucan controllers
...
# This target prepares repo for your provider by replacing all "ucan"
